...
export const posts: Post[] = [
    ...
    {
        id: 'p6',
        title: 'Scope 3 공급망 감사 착수',
        resourceUid: 'c5',
        dateTime: '2024-11-28 13:30',
        author: '박지수',
        content:
            '주요 협력사 5곳을 대상으로 Scope 3 배출량 공급망 감사를 시작했습니다. 결과에 따라 협력사 선정 기준에 탄소 배출 지표를 반영할 예정입니다.',
    },
];
